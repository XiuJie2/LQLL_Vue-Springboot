  ...
  <div>
    <div class="card" style="margin-bottom: 5px; ">
      ...
      <el-card style="border-radius: 10px; margin-bottom: 5px;">
        ...
        <el-button type="danger" @click="delBatch">批量刪除</el-button>
        <el-upload
      ...
      <el-card style="margin-bottom: 5px; ">
        <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="no" label="工號"/>
          <el-table-column prop="description" label="個人簡介" show-overflow-tooltip/>
...
<!--              <el-button link type="danger">删除</el-button>-->
    ...
    <el-dialog title="員工信息" v-model="data.formVisible" width="500" destory-on-close>
      <el-form ref="formRef" :rules="data.rule" :model="data.form" label-width="80px" style="padding-right: 40px; padding-top: 20px">
        ...
        <el-form-item label="賬號" prop="username">
          <el-input :disabled="data.form.id" v-model="data.form.username" autocomplete="off" placeholder="請輸入賬號"/>
        </el-form-item>
        ...
        <el-form-item label="年齡">
          <el-input-number style="width: 180px" :min="18" v-model="data.form.age" autocomplete="off" placeholder="請輸入年齡" />
        </el-form-item>
        ...
        <el-form-item label="個人簡介">
          <el-input type="textarea" :rows="2" v-model="data.form.description" autocomplete="off" placeholder="請輸入個人簡介"/>
        </el-form-item>
      </el-form>
...
const data = reactive({
  ...
  rule: {
    ...
    no: [
      {required: false, message: '請輸入工號', trigger: 'blur'}
    ]
  }
})
...
const exportData = () => {
  ...
  request.get('/employee/export/info')
}
